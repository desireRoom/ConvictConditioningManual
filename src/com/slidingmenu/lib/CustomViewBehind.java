...
import com.desire.ConvictConditioningManual.R;
...
public class CustomViewBehind extends ViewGroup {
	...
	public void drawSelector(View content, Canvas canvas, float openPercent) {
		...
		if (mSelectorDrawable != null && mSelectedView != null) {
			String tag = (String) mSelectedView.getTag(R.id.slidingmenu_selected_view);
	...
	public void setSelectedView(View v) {
		if (mSelectedView != null) {
			mSelectedView.setTag(R.id.slidingmenu_selected_view, null);
			mSelectedView = null;
		}
		if (v != null && v.getParent() != null) {
			mSelectedView = v;
			mSelectedView.setTag(R.id.slidingmenu_selected_view, TAG+"SelectedView");
			invalidate();
		}
	}
